...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 13. Feb 2021 um 12:59
...
(67, 19, 'weqw', '7616-capture-20210107-134046-crop.png'),
(68, 19, 'asdwakl', '3932-capture-20210107-134046-crop.png'),
(69, 19, 'asdwa', '6466-capture-20210107-110720-crop.png');
...
(19, 'hello', 'world', 'helloworld@mail.com', 'helloworld', '123123123', 'fc5e038d38a57032085441e7fe7010b0'),
(20, 'regoblok', 'blok', 'awedawkl@asdkk.com', 'regoblok', '0123912039', 'e19d5cd5af0378da05f63f891c7467af');
...
--
ALTER TABLE `inventar`
  MODIFY `inventar_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `student`
  MODIFY `student_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
