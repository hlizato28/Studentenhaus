    ...
    <div class="container">
      <div class="row">
		...
		<div class="table-responsive">
           ...
           $query = "SELECT Auftrag.auftrag_id, Waren.name, Inventar.menge FROM Waren, Inventar, Auftrag, Student WHERE Student.username = '".$_SESSION['username']."' AND Student.student_id = Auftrag.student_id AND Auftrag.inventar_id = Inventar.inventar_id AND Inventar.waren_id = Waren.waren_id";
