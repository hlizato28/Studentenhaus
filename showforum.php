<?php
    $db = mysqli_connect("sql7.freesqldatabase.com", "sql7579832", "5wuPuWeBwG", "sql7579832");
...
?>
    ...
    <div class="col-12 col-md-3">
        <div class="card">
            <img class="card-img-top" src="img/<?php echo $row["image"]; ?>" alt="Card image cap" style="height:225px">
